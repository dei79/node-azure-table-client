...
exports.defaultStorageProvider = require("./azure-table-client-default-backend.js");
exports.mockStorageProvider = require("./azure-table-client-mock-backend.js");

/*
 * Loads the standard storage provider which is able to communicate to azure table store.
 */
var activeStorageProvider = exports.defaultStorageProvider;
...
function AzureModelDefinition(definition) {
    ...
    self.queryNative = function(query, optionalDefaultValues, options) {
        ...
        if (options && options.top) {
            if (options.top <= 1000) { query = query.top(options.top); };
...
exports.config = function(storageAccountKey, storageAccountSecret) {
    activeStorageProvider.connect(storageAccountKey, storageAccountSecret)
};

/*
 * Allows to override the storage provider
 */
exports.setStorageProvider = function(storageProvider) {
